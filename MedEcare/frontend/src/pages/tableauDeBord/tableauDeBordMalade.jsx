    ...
    useEffect(() => {
        ...
        if (!token) {
            ...
            if (decodedToken) {
                ...
                // Initiate the startCapteurs fetch
                fetch(`${import.meta.env.VITE_API_URL_CAPTEURS}/startCapteurs`, {
                    ...
                    .then(() => {
                        ...
                        // Si on se connecte pour la premiere fois, on attend 16 secondes avant de lancer le premier fetch
                        if (firstFetch) {
                            setTimeout(() => {
                        ...
                        // Dans le cas ou ce nest pas un firstFetch, on lance le fetch toutes les 15 secondes
                    ...
                    .catch((error) => {
                        console.error("Error starting capteurs:", error.message);
                    });
            }
        }
    }, [navigate]);
